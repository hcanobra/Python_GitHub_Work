...
def q_posgresql_target_query ():
    v_sql_commands = ('''
                        ...
                        WHERE 
                        "Projects_local_market" = 'Boise'
                        AND
                        "Projects_Status" = 'Active'
                        AND 
                        "Projects_pl_initiative" IS NOT NULL
...
def q_posgresql_source_query ():
    v_sql_commands = ('''        
                    SELECT 
                            ...
                            "Call_Result",
                            geometry
                        FROM public."Idaho_US_2022_2H_All_Mobile_to_Mobile_Tests_geo"
                        WHERE 
                            "Network" = 'Verizon'
                            AND
                            "Call_Result" IN ('M2M BLOCK','M2M DROP')       
...
v_table = 'postgresql_Idaho_State_H2_Fuze'
