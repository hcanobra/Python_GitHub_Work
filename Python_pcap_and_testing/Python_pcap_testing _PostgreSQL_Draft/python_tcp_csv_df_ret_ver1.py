...
def f_ret (file_name,file):
  
    v_file = file_name
    
    
    # Open saved trace file 
    capture = pyshark.FileCapture(file_name, display_filter='tcp.analysis.out_of_order or tcp.analysis.retransmission or tcp.analysis.spurious_retransmission')
