...
def f_files(v_url):
    ...
    v_page = v_page[v_page['Name'].str.contains('saltlake') 
                    | v_page['Name'].str.contains('boise') 
                    | v_page['Name'].str.contains('montana')]                   # Subfilter the DF just for the filenes which match 'saltlake'
    v_page = v_page[v_page['Name'].str.contains('0000_0001')]                   # Subfilter the DF just for the filenes which match '0000_0001'
...
v_database = "vzw_fuze"
v_table  = "MTN_Cell_Ver"
v_url = 'http://datapro.eng.vzwcorp.com/download/sites_files/'
