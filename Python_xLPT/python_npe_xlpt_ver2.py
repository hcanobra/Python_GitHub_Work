...
def c_csv():
    v_file = '/Users/canobhu/Downloads/xLPT_tmp/DMPL_XLPT_ALL_VER2.csv'
...
def c_postgresql_bulk(df):
    ...
    insert_sql = sql.SQL("INSERT INTO {} ({}) VALUES %s").format(sql.Identifier("DMPL_XLPT_ALL_VER2"), columns)
